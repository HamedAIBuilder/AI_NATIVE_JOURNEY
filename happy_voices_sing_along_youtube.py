...
class HappyVoicesSingAlongYouTube:
    def __init__(self):
        self.songs = {
            "Twinkle, Twinkle, Little Star": {
                ...
                "youtube_url": "https://www.youtube.com/watch?v=yCjJyiqpAuU",
                "tempo": 2.0
            },
            "Row, Row, Row Your Boat": {
                ...
                "youtube_url": "https://www.youtube.com/watch?v=7otAJa3jui8",
                "tempo": 2.0
            },
            "Happy (Kid Version)": {
                "lyrics": [
            ...
            "Baby Shark": {
                ...
                "youtube_url": "https://www.youtube.com/watch?v=XqZsoesa55w",
                "tempo": 1.2
            },
            "Wheels on the Bus": {
                "lyrics": [
                ...
                "youtube_url": "https://www.youtube.com/watch?v=gEiuLN2IQIk",
                "tempo": 2.0
            }
        }
    ...
    def open_youtube_video(self, url):
        ...
        try:
            print(f"\n{self.colors[2]}🎬 Opening YouTube video in your browser...{self.reset}")
            webbrowser.open(url)
            return True
        except Exception as e:
            print(f"{self.colors[4]}❌ Error opening YouTube: {e}{self.reset}")
            print(f"{self.colors[3]}📋 You can manually copy and paste this URL: {url}{self.reset}")
            return False

    def display_lyrics(self, song_data):
        """Display lyrics with timing and colors"""
        lyrics = song_data["lyrics"]
        tempo = song_data["tempo"]
        youtube_url = song_data["youtube_url"]
        
        print(f"\n🎵 Now singing: {self.current_song} 🎵")
        print("=" * 50)
        
        # Ask if user wants to open YouTube
        print(f"\n{self.colors[3]}🎬 Would you like to open the YouTube video to sing along?{self.reset}")
        youtube_choice = input("Open YouTube video? (y/n): ").lower()
        
        if youtube_choice in ['y', 'yes']:
            self.open_youtube_video(youtube_url)
            print(f"\n{self.colors[2]}🎤 Start singing along with the video!{self.reset}")
        
        print(f"\n{self.colors[1]}📝 Here are the lyrics to follow:{self.reset}")
        print("=" * 50)
    ...
    def get_user_info(self):
        ...
        print("🎵 Welcome to Happy Voices Sing-Along with YouTube! 🎤")
    ...
    def run(self):
        ...
        if genre_choice == 1:
            available_songs = ["Twinkle, Twinkle, Little Star", "Row, Row, Row Your Boat", "Baby Shark", "Wheels on the Bus"]
        elif genre_choice == 2:
        ...
        self.print_colored("🎬 YouTube videos will help you sing along with the music! 🎵", '\033[96m')
...
def main():
    ...
    try:
        app = HappyVoicesSingAlongYouTube()
        app.run()
    except KeyboardInterrupt:
        print("\n\nGoodbye! 👋")
    except Exception as e:
